 ...
 */
function maxbusiness_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function maxbusiness_sanitize_css( $css ) {
 ...
 */
function maxbusiness_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function maxbusiness_sanitize_email( $email, $setting ) {
 ...
 */
function maxbusiness_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function maxbusiness_sanitize_html( $html ) {
 ...
 */
function maxbusiness_sanitize_image( $image, $setting ) {
 ...
 */
function maxbusiness_sanitize_nohtml( $nohtml ) {
 ...
 */
function maxbusiness_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function maxbusiness_sanitize_number_range( $number, $setting ) {
 ...
 */
function maxbusiness_sanitize_select( $input, $setting ) {
 ...
 */
function maxbusiness_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


function maxbusiness_sanitize_icon($icon){
	$icons = maxbusiness_font_awesome_icon_array();
