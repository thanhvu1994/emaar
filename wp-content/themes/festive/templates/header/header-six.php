 ...
 */
global $woocommerce; ?>
<header id="masthead" class="site-header site-header-six header-boxed-in <?php echo ( get_theme_mod( 'festive-set-header-nav-center-align' ) ) ? sanitize_html_class( 'site-header-nav-center' ) : ''; ?> <?php echo ( get_theme_mod( 'festive-set-header-align-right' ) ) ? sanitize_html_class( 'site-header-align-right' ) : ''; ?>">
