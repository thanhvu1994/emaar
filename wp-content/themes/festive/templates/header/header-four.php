 ...
 */
global $woocommerce; ?>
<header id="masthead" class="site-header site-header-four header-boxed-in <?php echo ( get_theme_mod( 'festive-set-header-nav-center-align' ) ) ? sanitize_html_class( 'site-header-nav-center' ) : ''; ?> <?php echo ( get_theme_mod( 'festive-set-header-align-right' ) ) ? sanitize_html_class( 'site-header-align-right' ) : ''; ?>">
                        ...
                        <div class="header-cart">
                            ...
                            <a class="header-cart-contents" href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'festive' ); ?>">
                                <span class="header-cart-amount">
                                    <?php echo sprintf( _n( '%d items', '%d items', $woocommerce->cart->cart_contents_count, 'festive' ), $woocommerce->cart->cart_contents_count ); ?> <?php echo $woocommerce->cart->get_cart_total(); ?>
                                </span>
