 ...
 */
global $woocommerce; ?>
<header id="masthead" class="site-header site-header-two <?php echo ( get_theme_mod( 'festive-set-header-align-right' ) ) ? sanitize_html_class( 'site-header-align-right' ) : ''; ?>">
