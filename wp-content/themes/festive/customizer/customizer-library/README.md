...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'festive' ), // Required
...
$options['example-text'] = array(
	'id' => 'example-text',
	'label'   => __( 'Example Text Input', 'festive' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'festive' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'festive' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-select'] = array(
	'id' => 'example-select',
	'label'   => __( 'Example Select', 'festive' ),
	'section' => $section,
	'type'    => 'select',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'festive' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
...
$options['example-radio'] = array(
	'id' => 'example-radio',
	'label'   => __( 'Example Radio', 'festive' ),
	'section' => $section,
	'type'    => 'radio',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-content'] = array(
	'id' => 'example-content',
	'label' => __( 'Example Content', 'festive' ),
	'section' => $section,
	'type' => 'content',
	'content' => '<p>' . __( 'Content to output. Use <a href="#">HTML</a> if you like.', 'festive' ) . '</p>',
	'description' => __( 'Optional: Example Description.', 'festive' )
);
~~~
