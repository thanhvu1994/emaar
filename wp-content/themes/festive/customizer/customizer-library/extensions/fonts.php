...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'festive' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'festive' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'festive' ),
		'cyrillic'     => __( 'Cyrillic', 'festive' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'festive' ),
		'devanagari'   => __( 'Devanagari', 'festive' ),
		'greek'        => __( 'Greek', 'festive' ),
		'greek-ext'    => __( 'Greek Extended', 'festive' ),
		'khmer'        => __( 'Khmer', 'festive' ),
		'latin'        => __( 'Latin', 'festive' ),
		'latin-ext'    => __( 'Latin Extended', 'festive' ),
		'vietnamese'   => __( 'Vietnamese', 'festive' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'festive' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'festive' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'festive' ),
