...
<div class="col-md-6 service-top1">
    ...
    <div  class="ser-top">
        ...
        <p>
            <?php echo get_field('short_content',$item->ID); ?>
            <span style="display:inline-block; text-align: right"><a href="<?php echo get_permalink($item->ID)?>" style="color:#27da93;">Read More</a></span>
        </p>
    </div>
